...
app.get('/qr', async (req, res) => {
  if (!lastQR) {
    return res.send(`<html><head><meta http-equiv="refresh" content="3"><style>body{font-family:sans-serif;text-align:center;padding:50px;background:#f0f9f4}</style></head><body><h2>⏳ Bot sudah aktif atau menunggu QR...</h2><p>Status: ${botStatus}</p><p>Refresh otomatis tiap 3 detik</p></body></html>`);
  }
